...
import heroImg01 from '../assets/images/plumber.jpeg'
import heroImg02 from '../assets/images/electrician.jpeg'
import heroImg03 from '../assets/images/painter.jpeg'
import heroImg04 from '../assets/images/mechanic.jpeg'
  ...
  return <>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
                  ...
                  <p className='text__para'>Yrs Experience</p>
                  </div>
      ...
      <div className='container'>
        <div className='lg:w-[470px] mx-auto'>
          <h2 className='heading text-center'>
            Providing the best home service
          </h2>
    ...
    {/* ============== Our great services ============== */}
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            <h2 className='heading text-center m-5'> Our Great Service </h2>
            <p className='text__para text-center mb-4'>
            World class service for everyone. Our Home Service System Offers unmatched, expert and skilled people. 
            From your home to the repair.
            </p>
    ...
    <br /><br /><br />
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            <h2 className='heading text-center m-5'> What our customers say</h2>
            <p className='text__para text-center mb-4'>
            World class service for everyone. Our Home Service System Offers unmatched, expert and skilled people. 
            From your home to the repair.
            </p>
